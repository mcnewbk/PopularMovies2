...
import com.mcnew.brandon.popularmovies.ResultEvents.FetchFavoriteMoviesTaskResultEvent;
 ...
 */
public class FetchFavoriteMoviesTask extends AsyncTask<ArrayList<String>, Void, ArrayList<MovieObject>> {
    ...
    @Override
    protected ArrayList<MovieObject> doInBackground(ArrayList... params) {
        ...
        try {
            ...
            ArrayList paramsId  = params[0];
            for(int i = 0; i < paramsId.size(); i++){
                final String movieId = (String)paramsId.get(i);
                ...
                MovieObject newMovie = getMovieDataFromJson(movieJsonString);
                movies.add(newMovie);
            }
